...
const ternaryLegends = {
    ter_age: new gridviz.TernaryLegend({
        ...
        texts: {
            ...
            "m12": "Under-representation of persons aged <15",
            "m02": "Under-representation of<br>persons aged 15 to 64",
    ...
    ter_mob: new gridviz.TernaryLegend({
        ...
        texts: {
            ...
            m12: "Under-representation of persons<br>that moved from outside the country",
            "m02": "Under-representation of persons<br>with residence unchanged",
            "m01": "Under-representation of persons<br>that moved within the country",
    ...
    ter_pob: new gridviz.TernaryLegend({
        ...
        texts: {
            ...
            m12: "Under-representation of persons<br>born outside the EU",
            "m02": "Under-representation of persons<br>born in the country",
            "m01": "Under-representation of persons<br>born in another EU country",
